...
// Generic type for HTML table elements
...
const TableHeader = React.forwardRef<HTMLTableSectionElement, THeadProps>(
  ({ className, ...props }, ref) => (
...
const TableFooter = React.forwardRef<HTMLTableSectionElement, TFootProps>(
  ({ className, ...props }, ref) => (
    <tfoot
      ref={ref}
      className={cn(
...
const TableRow = React.forwardRef<HTMLTableRowElement, TrProps>(
  ({ className, ...props }, ref) => (
    <tr
      ref={ref}
      className={cn(
...
const TableHead = React.forwardRef<HTMLTableCellElement, ThProps>(
  ({ className, ...props }, ref) => (
    <th
      ref={ref}
      className={cn(
...
const TableCell = React.forwardRef<HTMLTableCellElement, TdProps>(
  ({ className, ...props }, ref) => (
    <td
      ref={ref}
      className={cn(
